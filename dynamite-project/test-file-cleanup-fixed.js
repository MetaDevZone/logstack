...
async function testFileCleanup() {
  try {
    ...
    console.log("3. Testing file upload with cleanup...");
    ...
    // Run hourly job to trigger file creation and upload
    console.log("5. Running hourly job to trigger file cleanup...");
